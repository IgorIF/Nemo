$(document).ready(function () {
    ...
    /// Show edit trainer video modal
    $('[id="trainer_video_edit_btn"]').click(onTrainerVideoEditBtnClickListener);
    ...
    function updateTrainerVideo() {
        let data = new FormData($modalTrainerVideo.find('form')[0]);
        data.append('_method', 'PUT');
        data.append('action', 'videoUpdate');
    ...
    function promotionAdd(promotion) {
        ...
        content.find('input').change(onUpdateImageChangeListener);
    ...
    function videoSlickAdd(video) {
        let slide = $('<div class="slider video_' + video.id + '">' +
                        ...
                        '<div class="video-delete-container">' +
                            '<svg id="video_delete_btn" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash videoDeleteBtn" viewBox="0 0 16 16">' +
                                '<path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"></path>' +
                                '<path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"></path>' +
                            '</svg>' +
                            '<div id="deleteTooltip" class="delete-tooltip delete-video" tabindex="1">' +
                                'Удалить видео?' +
                                '<a class="button--border">Да</a>' +
                            '</div>' +
                        '</div>' +
    ...
    function securityItemAdd(securityItem) {
        ...
        let content = $('<div id="securityItem_' + securityItem.id + '" style="display: table; width: 100%">' +
                            ...
                            '<div class="item-delete-container">' +
                                '<svg id="securityItem_delete_btn" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash itemDeleteBtn" viewBox="0 0 16 16">' +
                                    '<path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"></path>' +
                                    '<path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"></path>' +
                                '</svg>' +
                                '<div id="deleteTooltip" class="delete-tooltip delete-security-item" tabindex="1">' +
                                    'Удалить запись?' +
                                    '<a class="button--border">Да</a>' +
                                '</div>' +
                            '</div>' +
    ...
    function vacancyAdd(vacancy) {
        ...
        let deleteBtnBlock = $('<div class="item-delete-container">' +
                                    '<svg id="vacancy_delete_btn" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash itemDeleteBtn" viewBox="0 0 16 16">' +
                                        ...
                                        '<path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"></path>' +
                                    '</svg>' +
                                    '<div id="deleteTooltip" class="delete-tooltip delete-vacancy" tabindex="1">' +
                                        'Удалить запись?' +
                                        '<a class="button--border">Да</a>' +
                                    '</div>' +
                                '</div>');
    ...
    function setBackgroundImageChangeAreaDimensions() {
        let containers = $('div[class*="tab_item"]').add('div[class*="tab_item2"]');
