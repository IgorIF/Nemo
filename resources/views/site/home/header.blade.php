    ...
    <div class="container header__flex">
        ...
        <div class="header__contacts">
            ...
            <div class="header__phone">
                <a href="tel:+74951200252" onclick="ym(45529422,'reachGoal','number'); return true;">+7 (495) 120-02-52</a>
                Единый номер
            </div>
        </div>
        ...
        <div class="mobil-menu">
            <div class="mobil-menu__contacts">
                {{--<a href="https://api.whatsapp.com/send?phone=74951206711" class="header__wa" target="_balnk" onclick="ym(45529422,'reachGoal','Whatsapp'); return true;"><img src="{{ asset('images/dist/icon/whatsApp.svg') }}" alt=""></a>--}}
                <div class="header__phone">
                    <a href="tel:+74951200252" onclick="ym(45529422,'reachGoal','number'); return true;">+7 (495) 120-02-52</a>
                    Единый номер
                </div>
