<h2 data-aos="fade-up" id="text_{{ $texts->get(31)->id }}" contenteditable="true">{!! $texts->get(31)->text !!}</h2>
...
<div class="age-of-child-items">
    <div class="tabs" data-aos="fade-up">
        ...
        <div class="tab center">
            ...
            <p id="text_{{ $texts->get(33)->id }}" contenteditable="true">{!! $texts->get(33)->text !!}</p>
        </div>
        <div class="tab right">
            <picture>
            ...
            <p id="text_{{ $texts->get(34)->id }}" contenteditable="true">{!! $texts->get(34)->text !!}</p>
        </div>
    </div>
