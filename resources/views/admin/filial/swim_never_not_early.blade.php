...
<div class="left">
    ...
    <p data-aos="fade-up" id="filialBranch_swimNeverNotEarly_{{ $filialBranch->id }}" contenteditable="true">{!! $filialBranch->swimNeverNotEarly !!}<span class="discount-sum"></span>
    </p>
