...
<div class="phone1">
    ...
    <address>
        ...
        <div id="filialBranch_metro_{{ $filialBranches->get(1)->id }}" contenteditable="true">(метро {!! $filialBranches->get(1)->metro !!})</div>
    </address>
</div>
...
<div class="phone2">
    ...
    <address>
        ...
        <div id="filialBranch_metro_{{ $filialBranches->get(2)->id }}" contenteditable="true">(метро {!! $filialBranches->get(2)->metro !!})</div>
    </address>
</div>
...
<div class="phone2">
    ...
    <address>
        ...
        <div id="filialBranch_metro_{{ $filialBranches->get(3)->id }}" contenteditable="true">(метро {!! $filialBranches->get(3)->metro !!})</div>
    </address>
</div>
...
<div class="phone2">
    ...
    <address>
        ...
        <div id="filialBranch_metro_{{ $filialBranches->get(4)->id }}" contenteditable="true">(метро {!! $filialBranches->get(4)->metro !!})</div>
    </address>
</div>
<div class="phone2">
    ...
    <address>
        ...
        <div id="filialBranch_metro_{{ $filialBranches->get(5)->id }}" contenteditable="true">(метро {!! $filialBranches->get(5)->metro !!})</div>
    </address>
</div>
