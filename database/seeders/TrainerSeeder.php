...
class TrainerSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('trainers')->insert([
            'name' => 'Окулова Любовь',
            'image' => '12.jpg',
            'description' => 'Имею инструкторские звания по Дайвингу, являюсь дипломированным тренером. Прошла специализацию по обучению плаванию детей с «0». В настоящее время тренирую учеников с "0" до 79 лет (самый взрослый ученик на сегодня). С большим удовольствием делюсь своими знаниями. Очень люблю тренировать малышей. Знаю, что могу внести свой вклад в снятие страхов воды, воспитать уверенность в своих силах независимо от возраста, но главное научить наших деток активному, здоровому образу жизни. Тренировки с детьми от 0 до 6 лет - это огромное удовольствие!!! Родители могут наблюдать за тренировками, видеть как их Чудо Чадо с первого занятия уверенно держится на воде, начинает нырять, плавать - радость ребенку и гордость родителей за свое Сокровище!'
        ]);

        DB::table('trainers')->insert([
            'name' => 'Елена Октябрьская',
            'image' => '13.jpg',
            'description' => 'В работе использую индивидуальный подход не только к детям, но и к родителям, на мой взгляд очень важно, чтобы самые близкие для ребёнка люди тоже были вовлечены в процесс тренировок. Легко могу придумать новую игру ориентируясь на возраст, настроение, уровень подготовки ребёнка, и, другие факторы, которые могут повлиять на ход занятия. В 2013 году прошла обучение в школе инструкторов детского плавания «Непоседа», что подтверждается соответствующим сертификатом. Со спортом я дружу с 3-х лет: занималась плаванием, художественной гимнастикой, акробатикой, но в итоге нашла себя в спортивной аэробике и имею звание кандидата в мастера спорта. В 2020 году получила степень магистра педагогики, опыт работы с детьми более 12 лет.'
        ]);
